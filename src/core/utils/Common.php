<?php
// core/utils/common.php

/**
 * Clase de utilidades comunes para el generador CRUD
 */
class Utils {
    
    /**
     * Limpia y formatea un nombre de aplicación
     */
    ...
    public static function getColumnInputType($columnType) {
        ...
        } elseif (strpos($columnType, 'email') !== false) {
            return 'email';
        } elseif (strpos($columnType, 'url') !== false) {
            return 'url';
        } elseif (strpos($columnType, 'text') !== false) {
            return 'textarea';
        } elseif (strpos($columnType, 'bool') !== false) {
